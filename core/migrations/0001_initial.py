# Generated by Django 5.2.7 on 2025-12-18 04:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', django_ckeditor_5.fields.CKEditor5Field(blank=True, default='Product Description', null=True, config_name='default')),
                ('price', models.DecimalField(decimal_places=2, default=1.99, max_digits=10)),
                ('old_price', models.DecimalField(decimal_places=2, default=2.99, max_digits=10)),
                ('specifications', django_ckeditor_5.fields.CKEditor5Field(blank=True, null=True, config_name='default')),
